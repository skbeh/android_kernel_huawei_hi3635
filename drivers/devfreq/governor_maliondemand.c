...
#define DFMO_MAX_ANIMATION_BOOST_FREQ	(700000000)
#define DFMO_MIN_HISPEED_FREQ		(200000000)
#define DFMO_MAX_HISPEED_FREQ		(700000000)
...
#define DFMO_MIN_ANIMATION_BOOST_FREQ	(299000000)
#define DFMO_DEFAULT_ANIMATION_BOOST_FREQ	(700000000)

#ifdef DFMO_REQUEST_QOS_CPU_DMA_LATENCY
#define DFMO_MIN_FREQ_FOR_QOS_CPU_DMA_LATENCY		(200000000)
#ifdef CONFIG_ARCH_HI3630
#define DFMO_MAX_FREQ_FOR_QOS_CPU_DMA_LATENCY		(700000000)
